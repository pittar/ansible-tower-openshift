...
RUN sh -c ". /var/lib/awx/venv/ansible2.9/bin/activate ; pip install --upgrade pip"
RUN sh -c ". /var/lib/awx/venv/ansible2.9/bin/activate ; pip install ansible==2.9.13.0"
